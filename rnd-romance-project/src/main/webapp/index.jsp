...
<body>
	...
	<nav
		...
		<div class="collapse navbar-collapse" id="navbarCollapse">
			<div class="navbar-nav ms-auto p-4 p-lg-0">
				...
				<a href="calendar_test.jsp" class="nav-item nav-link">Calendar</a> <a
					href="profile.jsp" class="nav-item nav-link">Profile</a>
				<div class="nav-item dropdown">
					<a href="#" class="nav-link dropdown-toggle"
						data-bs-toggle="dropdown">Pages</a>
					<div class="dropdown-menu bg-light m-0">
						<a href="feature.jsp" class="dropdown-item">Features</a> <a
							href="quote.jsp" class="dropdown-item">Free Quote</a> <a
					...
					<div class="carousel-caption">
						<div class="container">
							<div class="row justify-content-center">
								<div class="col-lg-7">
									<h1 class="display-1 text-white mb-5 animated slideInDown">YOU
										WERE THE</h1>
									<h1 class="display-1 text-white mb-5 animated slideInDown"
										style="font-color: green;!important">MENTOR</h1>
									<a href="" class="btn btn-primary py-sm-3 px-sm-4">Get
										Mentor Recommendation</a>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="portfolio-text">
							...
							<div class="d-flex">
								...
								<iframe width="auto" height="auto"
									src="https://www.youtube.com/embed/03qXDRVIPcA"
									title="K-미래에서는 모두가 승자입니다 | 샘 리처드 펜실베니아주립대 교수, 로리 멀비 ‘World In Conversation’ 디렉터 | 지식 GSEEK | 세바시 1556회"
									frameborder="0"
	...
	<div style="text-align: center;">
		<a href="" class="btn btn-primary py-sm-3 px-sm-4"
			style="background: #4a69bd; border-radius: 20px; border-color: white;">Recommend
			Mentor Video</a>
	</div>
	<br>
	<br>
