...
<body>
	...
	<% 
        ...
        /* 랜덤감 */
        int[] numbers = new int[9]; // 9개의 정수를 담는 배열 선언
         ...
         numbers[insertCur] = (int)(Math.random() * totalMentors);
                ...
                <%
                	String html = "";
               		...
               		for (int i =0; i < 9; i++) {
	                	...
	                	htmlImage = "./file/"+selectRandomMentorList.get(numbers[i]).getMember_image_file();
	                	htmlMemberName = "profile.jsp?profile_name=" + selectRandomMentorList.get(numbers[i]).getMember_name();
	                	htmlShowMemberName = selectRandomMentorList.get(numbers[i]).getMember_name();
