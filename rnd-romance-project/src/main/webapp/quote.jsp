                ...
                <div class="col-lg-7">
                    <div class="bg-light rounded p-4 p-sm-5 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="row g-3">
                            ...
                            <div class="col-sm-6">
                                <div class="form-floating">
                                    Your Email<input type="text" name="email" class="form-control border-0" id="gmail" placeholder="Gurdian Email">
                            ...
                            <div class="col-12">
                                <div class="form-floating">
                                    <textarea class="form-control border-0" name ="textarea" placeholder="Leave a message here" id="message" style="height: 100px"></textarea>
                                    <label for="message">Message</label>
                                </div>
                            </div>
                            <div>
                                <input type="submit" value="Login" class="col-12 text-center">
                            </div>
                        </div>
                    </div>
                </div>
