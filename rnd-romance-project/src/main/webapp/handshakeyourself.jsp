...
<!--     Page Header Start
    ...
    <!-- 404 Start -->
    <div class="container-xxl py-5 wow fadeInUp" data-wow-delay="0.1s" style="margin-top: 8rem;">
        <div class="container text-center">
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <!-- <i class="bi bi-exclamation-triangle display-1 text-primary"></i> -->
                    <!-- <h1 class="display-1">Mentorvation</h1> -->
                    <h1 class="mb-4" style="font-size: 2.3rem;">나 자신은 영원한 인생의 멘토입니다.</h1>
                    <br>
                    <!-- <p class="mb-4"></p> -->
                    <a class="btn btn-primary py-3 px-4" href="index.jsp">Go Back To Home</a>
                </div>
            </div>
        </div>
    </div>
